...
PREVIOUS NOTES
- y values in ground pgm file were modified by the division of 23
- acceleration/deceleration direction depends on previous moves
- there are 20 humans 
- there are now 18 aliens
- the rays depend on the last movement direction made
- humans die if they fall from more than 13 units from the ground 
- aliens move down to pick up humans, than back up to sky 
- alien search range is 5 units

***CURRENT NOTES***
	-some aliens (including the player/vp) have been put close to the ground for better observing collisions with the ground 
	-because of the collisions with the ground aliens may continuously try to collect a human off the ground while bouncing off the ground 
	-transformed aliens are red and pink, transformed after taking a human to the sky 
	-the shooting range for the alien is 20 units, 5 seconds in between each shot 
	-the game engine has a limit to the amount of rays it can draw on screen, so there will only be a max of 15 rays drawn on the screen simultaneously 
	-i've tried to put the aliens close together to view collisions better, but if it's hard to see at the beginning, leave all the aliens to transform, it becomes easier to see the collisions between aliens 
